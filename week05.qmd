...
![](figures/week05/demand_and_supply.png)
...
::: {#fig-compounding}
![](figures/week05/compounding.png){width=50%}
...
![](figures/week05/financial_functions.png)
...
::: {#fig-balance-sheet}
![](figures/week05/balance_sheet.png){width=70%}
...
This logic explains several institutional features of financial markets that might otherwise seem puzzling. It explains why **investment banks** exist as underwriters: they perform due diligence on issuers and certify their quality to investors, using their reputation as a bond. It explains why **credit rating agencies** exist: they provide standardized assessments of credit quality to investors who cannot evaluate each issuer individually. It explains why **collateral** is so important in lending: a borrower who puts up collateral is credibly signaling that they believe they will repay, since a defaulting borrower loses the collateral. And it explains why **disclosure requirements** — mandatory reporting of financial statements, material events, and insider transactions — are a central feature of securities regulation.
...
The principal-agent problem explains why manager compensation is often tied to firm performance through stock options and equity grants — aligning manager incentives with shareholder interests. It explains why **covenants** in debt contracts restrict borrower behavior — limiting dividends, requiring minimum asset ratios, preventing certain risky investments. And it explains why large institutional investors engage in active governance — attending shareholder meetings, voting proxies, and pressuring management — rather than simply selling their shares when they are unhappy.
